function [CallFFT K lambdainc eta] = HestonCallFFT(N,uplimit,S0,r,q,tau,kappa,theta,lambda,rho,sigma,v0,Trap,alpha,fast,rule)
...
elseif fast==0
	...
	for u=1:N
		for j=1:N
			psi(j) = HestonCF(v(j)-(alpha+1)*i,kappa,theta,lambda,rho,sigma,tau,S0,r,q,v0,Trap);
