...
namespace Bounds_on_Alpha
{
    class GlobalVars
    {
        public static string ObjFunChoice;
    }
    class NelderMeadAlgo
    {
        ...
        public delegate double ObjFun(double[] x,double[] param);

        //========================================================================================================================
        // Nelder Mead Algorithm
        //========================================================================================================================
        public double[] NelderMead(ObjFun f,int N,double NumIters,double MaxIters,double Tolerance,double[,] x,double[] param)
        {
            int i,j;
        ...
        step0:
            ...
            for(j=0;j<=N;j++)
            {
                ...
                {
                    z[i] = x[i,j];
                    F[j][0] = f(z,param);		                 					// Function values
        ...
        static double[] VAdd(double[] X,double[] Y)
        {
            int N = X.Length;
            double[] Z = new Double[N];
            for(int j=0;j<=N-1;j++)
        ...
        static double[] VSub(double[] X,double[] Y)
        {
            int N = X.Length;
            double[] Z = new Double[N];
            for(int j=0;j<=N-1;j++)
        ...
        static double[] VMult(double[] X,double a)
        {
            int N = X.Length;
            double[] Z = new Double[N];
            for(int j=0;j<=N-1;j++)
