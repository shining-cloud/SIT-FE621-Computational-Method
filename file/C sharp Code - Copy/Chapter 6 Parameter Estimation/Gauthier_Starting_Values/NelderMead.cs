...
namespace Gauthier_Starting_Values
{
    class NelderMeadAlgo
    {
        ...
        public delegate double ObjFun(double[] x,double[] Coeff1,double[] Coeff2,double Put1,double Put2);

        // Nelder Mead Algorithm ===============================================================================================
        public double[] NelderMead(ObjFun f,int N,double NumIters,int MaxIters,double Tolerance,double[,] x,double[] Coeff1,double[] Coeff2,double Put1,double Put2)
        {
            int i,j;
        ...
        step0:
            ...
            for(j=0;j<=N;j++)
            {
                ...
                {
                    z[i] = x[i,j];
                    F[j][0] = f(z,Coeff1,Coeff2,Put1,Put2);             // Function values
