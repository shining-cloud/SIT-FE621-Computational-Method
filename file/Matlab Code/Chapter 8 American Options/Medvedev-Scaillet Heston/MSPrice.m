function [EuroPutClosed AmerPutMS AmerPut EEP theta y] = MSPrice(S,Strike,T,r,q,params,trap,method,A,B,N,NumTerms,yinf)
...
lo = max(2,theta);
y = fminbnd(@(p) -MSPutHeston(p,theta,Strike,params,r,q,T,NumTerms),lo,3);
if y<theta
    y = theta;
end
