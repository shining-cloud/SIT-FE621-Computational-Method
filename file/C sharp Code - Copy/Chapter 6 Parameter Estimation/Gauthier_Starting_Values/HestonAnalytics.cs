...
namespace Gauthier_Starting_Values
{
    class HestonPrice
    {
        ...
        static Complex HestonCF(Complex phi,HParam param,double S,double r,double q,double T,int trap)
        {
        ...
        static Complex AttariCF(double phi,HParam param,double Tau,double Spot,double Rate,double Div,int Trap)
        {
