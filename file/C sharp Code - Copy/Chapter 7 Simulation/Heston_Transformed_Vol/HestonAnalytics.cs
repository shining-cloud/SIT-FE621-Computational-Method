...
namespace Transformed_Volatility
{
    ...
    {
        // Heston Integrand
        static double HestonProb(double phi,HParam param, OpSet settings, int Pnum)
        {
        ...
        static double HestonPriceGaussLaguerre(HParam param, OpSet settings,double[] x, double[] w)
        {
