...
namespace Double_Heston_Estimation
{
    ...
    {
        // Heston Integrand
        public Complex HestonDoubleCF(Complex phi,DHParam param,OpSet settings)
        {
            Complex i = Complex.ImaginaryOne;                   // Imaginary unit
            double S = settings.S;
            double K = settings.K;
            double T = settings.T;
            double r = settings.r;
        ...
        public double DoubleHestonPriceNewtonCotes(DHParam param,OpSet settings,double a,double b,int N)
        {
            double S = settings.S;
            double K = settings.K;
            double r = settings.r;
            ...
            {
                u = phi[k];
                f2[k] = HestonDoubleCF(u,param,settings);
                f1[k] = HestonDoubleCF(u-i,param,settings);
